...
export const toggleCategoryBlock = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const getBlockedCategories = async (_req: Request, res: Response) => {
  try {
...
export const getUnblockedCategories = async (_req: Request, res: Response)=> {
  try {
    const categories = await Category.find({ isBlocked: false });
